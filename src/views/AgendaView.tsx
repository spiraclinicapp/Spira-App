                ...
                {visits.map((v) => {
                  ...
                  const inner = (
                    <>
                      ...
                      <div style={{ fontSize: 12.5, color: 'var(--spira-ink)', marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{v.patient_name}</div>
                      <div style={{ fontSize: 12, color: 'var(--spira-muted)', marginTop: 2 }}>
