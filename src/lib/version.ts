...
export const SPIRA_VERSION = {
  ...
  changelog: [
    { version: '0.53', text: 'Elegís en qué módulo abre Spira y a dónde te lleva el logo: en Ajustes › Preferencias, la página de inicio puede ser cualquiera de tus módulos, además de Inicio o el último que usaste. La barra de módulos deja de mostrar candados: ahora solo aparecen los que tenés habilitados. Y en la visita, el botón de medicación concomitante dice "Elegir medicación", que es lo que hace: abre la lista de la medicación que el paciente tiene asignada.' },
