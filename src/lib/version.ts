...
export const SPIRA_VERSION = {
  ...
  changelog: [
    { version: '0.91', text: 'El saludo de Inicio tiene frases para cada día y avisa los feriados que se vienen.' },
    { version: '0.90', text: 'El retest y la VNP llevan sus procedimientos, y lo pendiente de una visita se pasa a otro día.' },
