...
function pedido(items: RequestItemRow[]): DispensationRequestRow {
  return {
    ...
    prepared_by: null, prepared_by_name: null, preparation_started_at: null, items, dispensations: [],
    includes_ip: false, off_schedule: false, off_schedule_reason: null, base_sin_cronograma: false, ip_documents: [],
