...
-- ── Protocolo: investigador principal, especialidad, fase, código interno ───
alter table public.protocols
  ...
  add column if not exists phase                  text,  -- fase del ensayo (ej. "Fase III")
...
comment on column public.protocols.phase is 'Fase del ensayo clínico.';
